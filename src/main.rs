...
fn main() {
    ...
    if opt.ascii {
        ...
        for i in 0x00_00_00_00_00u64 ..= 0xff_ff_ff_ff_ffu64 {
            ...
            let i
                = ((i <<  0) & 0x__________________0f) | ((i <<  1) & 0x__________________20)
                | ((i <<  3) & 0x_______________0f_00) | ((i <<  4) & 0x_______________20_00)
                | ((i <<  6) & 0x____________0f_00_00) | ((i <<  7) & 0x____________20_00_00)
                | ((i <<  9) & 0x_________0f_00_00_00) | ((i << 10) & 0x_________20_00_00_00)
                | ((i << 12) & 0x______0f_00_00_00_00) | ((i << 13) & 0x______20_00_00_00_00) 
                | ((i << 15) & 0x___0f_00_00_00_00_00) | ((i << 16) & 0x___20_00_00_00_00_00) 
                | ((i << 18) & 0x0f_00_00_00_00_00_00) | ((i << 19) & 0x20_00_00_00_00_00_00);
